...
public final class Messages {
	...
	public static final class UtilSqlMessage{
		...
		private UtilSqlMessage() {
			...
			public static final String CONNECTION_IS_OPEN_TECHNICAL_NULL_CONNECTION_STRING = "Se ha ´presentado un problema de tipo SQLException tratando de validar si la conexion estaba o no abierta.Valide la traZA DE errores completa de la exception presentada";
			public static final String CONNECTION_IS_OPEN_TECHNICAL_SQL_EXCEPTION_STRING = "Se ha ´presentado un problema de tipo SQLException tratando de validar si la conexion estaba o no abierta..Valide la traZA DE errores completa de la exception presentada";
			public static final String CONNECTION_IS_OPEN_TECHNICAL_EXCEPTION_STRING = "Se ha ´presentado un problema de tipo Exception tratando de validar si la conexion estaba o no abierta...Valide la traZA DE errores completa de la exception presentada";
		...
		public static final class EstadoTipoRelacionInstitucionFacadeImplMessage {
			...
			private EstadoTipoRelacionInstitucionFacadeImplMessage() {
		...
		public static final class EstadoTipoRelacionInstitucionBusinessImplMessage{
			...
			private EstadoTipoRelacionInstitucionBusinessImplMessage() {
		...
		public static final class SQLServerDAOMessage {
			
private SQLServerDAOMessage() {
			...
			public static final String USER_READ_PROBLEM_STRING="Se ha presentado un problema tratando de dar de consultar la informacion de los estados tipo relacion institucion...";
			public static final String TECHNICAL_READ_PROBLEM_STRING="Se ha presentado un problema de tipo SQL EXCEPTIONdentro del metodo de la clase\"\r\n"
					+ "					+ \" setParameters de ETRI SQL server DAO. Porfavor verifica la traza completa del error";
			public static final String USER_READ_UNEXPECTED_PROBLEM_STRING="Se ha presentado un problema inesperado tratando de dar de consutar la informacion ";
			public static final String TECHNICAL_READ_UNEXPECTED_PROBLEM_STRING="Se ha presentado un problema inesperado de tipo setParameters dentro del metodo de la clase delete de ETRI SQL server DAO. Porfavor verifica la traza completa del error";
		}
