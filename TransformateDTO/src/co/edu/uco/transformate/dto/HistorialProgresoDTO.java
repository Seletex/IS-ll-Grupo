...
public class HistorialProgresoDTO {
	...
	public HistorialProgresoDTO(UUID identificador, LocalDate fecha, String descripcion,
	...
	public HistorialProgresoDTO setNombreMiembro(String nombreMiembro) {
		this.nombreMiembro = UtilText.getUtilText().applyTrim(nombreMiembro);return this;
	}
	...
	public HistorialProgresoDTO setDescripcion(String descripcion) {
		this.nombreMiembro = UtilText.getUtilText().applyTrim(descripcion);return this;
	}
}
