...
public class TipoPagoSQLServerDAO extends SQLDAO<TipoPagoEntity> implements TipoPagoDAO{

	@Override
	public List<TipoPagoEntity> read(TipoPagoEntity entity) {
	...
	protected String prepareFrom() {
		return "FROM TipoPago ";
	}

	@Override
	protected String prepareWhere(TipoPagoEntity entity, List<Object> parameters) {
	...
	@Override
	protected List<TipoPagoEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<TipoPagoEntity> resultEntities = new ArrayList<>();
		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				final var entityTmp = new TipoPagoEntity(resultSet.getObject("identificador", UUID.class),
