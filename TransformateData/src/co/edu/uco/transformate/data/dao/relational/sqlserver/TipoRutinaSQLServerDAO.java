...
public class TipoRutinaSQLServerDAO extends SQLDAO<TipoRutinaEntity>  implements TipoRutinaDAO{

	@Override
	public List<TipoRutinaEntity> read(TipoRutinaEntity entity) {
	...
	@Override
	protected String prepareWhere(TipoRutinaEntity entity, List<Object> parameters) {
	...
	@Override
	protected List<TipoRutinaEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<TipoRutinaEntity> resultEntities = new ArrayList<>();
		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				final var entityTmp = new TipoRutinaEntity(resultSet.getObject("identificador", UUID.class),
