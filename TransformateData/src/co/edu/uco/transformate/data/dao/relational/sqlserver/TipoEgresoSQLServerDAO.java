...
public class TipoEgresoSQLServerDAO extends SQLDAO<TipoEgresoEntity> implements TipoEgresoDAO{

	@Override
	public List<TipoEgresoEntity> read(TipoEgresoEntity entity) {
	...
	protected String prepareFrom() {
		return "FROM TipoEgreso ";
	}

	@Override
	protected String prepareWhere(TipoEgresoEntity entity, List<Object> parameters) {
	...
	@Override
	protected List<TipoEgresoEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<TipoEgresoEntity> resultEntities = new ArrayList<>();
		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				final var entityTmp = new TipoEgresoEntity(resultSet.getObject("identificador", UUID.class),
