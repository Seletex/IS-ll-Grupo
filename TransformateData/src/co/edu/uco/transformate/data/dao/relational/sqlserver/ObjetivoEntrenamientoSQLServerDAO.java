...
public class ObjetivoEntrenamientoSQLServerDAO extends SQLDAO<ObjetivoEntrenamientoEntity> implements ObjetivoEntrenamientoDAO{

	@Override
	public List<ObjetivoEntrenamientoEntity> read(ObjetivoEntrenamientoEntity entity) {
	...
	protected String prepareFrom() {
		return "FROM ObjetivoEntrenamiento ";
	}

	@Override
	protected String prepareWhere(ObjetivoEntrenamientoEntity entity, List<Object> parameters) {
	...
	@Override
	protected List<ObjetivoEntrenamientoEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<ObjetivoEntrenamientoEntity> resultEntities = new ArrayList<>();
		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				final var entityTmp = new ObjetivoEntrenamientoEntity(resultSet.getObject("identificador", UUID.class),
