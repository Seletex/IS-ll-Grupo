...
public class TipoDocumentoSQLServerDAO extends SQLDAO< TipoDocumentoEntity> implements TipoDocumentoDAO{
	...
	protected List<TipoDocumentoEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<TipoDocumentoEntity> resultEntities = new ArrayList<>();
		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				final var entityTmp = new TipoDocumentoEntity(resultSet.getObject("identificador", UUID.class),
