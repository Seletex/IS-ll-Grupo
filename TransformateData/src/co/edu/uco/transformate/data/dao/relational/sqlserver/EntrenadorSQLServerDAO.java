...
public class EntrenadorSQLServerDAO extends SQLDAO<EntrenadorEntity> implements EntrenadorDAO{

	@Override
	public void create(EntrenadorEntity entity) {
		final var sqlStatement = "INSERT INTO Entrenador (identificador, tipoDocumento,identificacion,"
	...
	@Override
	public List<EntrenadorEntity> read(EntrenadorEntity entity) {
	...
	@Override
	public void update(EntrenadorEntity entity) {
		final var sqlStatement = "UPDATE Entrenador SET nombre=?,usuario=?,telefono=?,salario=?, gimnasio=? WHERE Identificador = ?";
		try (var preparedStatement = getConnection().prepareStatement(sqlStatement)) {
	...
	@Override
	public void delete(EntrenadorEntity entity) {
		final var sqlStatement = "DELETE FROM Entrenador WHERE Identificador = ? ";
		try (var preparedStatement = getConnection().prepareStatement(sqlStatement)) {
	...
	@Override
	protected String prepareWhere(EntrenadorEntity entity, List<Object> parameters) {
	...
	@Override
	protected List<EntrenadorEntity> executeQuery(PreparedStatement preparedStatement) {
		final List<EntrenadorEntity> resultEntities = new ArrayList<>();
		try (var resultSet = preparedStatement.executeQuery()) {
			while (resultSet.next()) {
				final var entityTmp = new EntrenadorEntity(resultSet.getObject("identificador", UUID.class),
