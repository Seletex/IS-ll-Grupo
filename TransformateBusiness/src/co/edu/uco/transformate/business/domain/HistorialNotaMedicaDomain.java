...
public class HistorialNotaMedicaDomain {
	...
	public static HistorialNotaMedicaDomain create(UUID identificadorUuid, LocalDate fechaDate, String descripcion,
			String nombreMiembroString) {
		return new HistorialNotaMedicaDomain(identificadorUuid,fechaDate,descripcion,nombreMiembroString);
	}

	public  HistorialNotaMedicaDomain(UUID identificadorUuid, LocalDate fechaDate, String descripcion,
			String nombreMiembroString) {
