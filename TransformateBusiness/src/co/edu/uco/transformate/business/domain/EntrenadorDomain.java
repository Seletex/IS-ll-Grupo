...
public class EntrenadorDomain {
	...
	private static final EntrenadorDomain DEFAULT_OBJECT = new EntrenadorDomain();

	public static EntrenadorDomain getDefaultObject() {
		return DEFAULT_OBJECT;
	}

	public static EntrenadorDomain create(final UUID identificador, final TipoDocumentoDomain tipoDocumentoDomain,
		...
		return new EntrenadorDomain(identificador,tipoDocumentoDomain,identificacion,nombre,usuario,constraseña,telefono,salario,gimnasioDomain);
	}

	public  EntrenadorDomain(final UUID identificador, final TipoDocumentoDomain tipoDocumentoDomain,
			final String identificacion, final String nombre, final String usuario, final String constraseña,
			final String telefono, final int salario, final GimnasioDomain gimnasioDomain) {
	...
	public static EntrenadorDomain create() {
		return new EntrenadorDomain();
	}
